...
func run():
 ...
 expect(is_equal_approx(view.table.field_position("item",0,4,0).x,-7.55) and is_equal_approx(view.table.field_position("support",0,2,0).z,3.23),"3D item and barrier rows follow the divided zones")
