...
func run():
 ...
 expect(view.table.board.mesh.size==view.table.TOP_DOWN_BOARD_SIZE and is_equal_approx(view.table.board.mesh.size.aspect(),1.0),"2D playmat preserves the square source image ratio")
 view.close_overlay()
