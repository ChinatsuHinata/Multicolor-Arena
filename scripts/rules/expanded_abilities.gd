...
static func spell_options(e,id: String,who: int) -> Variant:
 ...
 match id:
  ...
  "94","163":
   var result=[]
   for u in e.units(who).filter(func(v):return e.can_sacrifice(v)):
...
static func resolve_trigger(e,t: Dictionary):
 ...
 match effect:
  ...
  "delayed_return":
   ...
   else:e.failed_delayed_return(t)
  "combat_exile_target":
...
static func activation_options(e,c: Dictionary,key: String) -> Array:
 ...
 match key:
  ...
  "sacrifice_buff": return refs(e,e.units(c.owner).filter(func(u):return e.can_sacrifice(u)))
  "leader_bounce": return unit_refs(e,c.owner)
 return []
