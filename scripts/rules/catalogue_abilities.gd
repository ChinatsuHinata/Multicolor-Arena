...
static func add_paired_mana(e,who,colors):
 var pool=e.players[who].get("mana",[])
 pool.append({"uid":-1000-e.next_uid,"colors":["/".join(colors)],"pair":colors.duplicate(),"weight":0,"kind":"floating"})
 e.next_uid+=1;e.players[who].mana=pool
