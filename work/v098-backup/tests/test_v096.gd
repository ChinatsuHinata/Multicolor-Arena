...
func run():
 ...
 expect(view.debug_open and view.browser_cards is GridContainer and view.browser_cards.columns==3,"surface pile opens a three-column grid")
 ...
 expect(view.browser_cards.get_child(8).position.y+117<view.browser_scroll.size.y,"at least nine full card faces fit in sidebar")
