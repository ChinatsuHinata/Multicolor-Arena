...
const HANDLERS=["marisa_enter","marisa_spell","brave","exterminate","damage","counter_card","mana","grant_leader_abilities","activated_damage","annihilate","flash","turn_buff","extension","precon"]
