...
work = root / 'work/bugfix0921'
out = root / 'builds/Windows-1.0-bugfix0921'
archive = root / 'builds/MulticolorArena-1.0-bugfix0921-win64.zip'
env = os.environ.copy()
...
for name in ['test_bugs0921_rules', 'test_bugs0921_ui-visual', 'test_bugs0921_network', 'test_portable', 'test_portable_ui-visual', 'test_v0182_rules', 'test_v0181_series', 'test_v0181_ui-visual', 'test_v1_network', 'test_v1_ui-visual']:
...
if '--package-only' not in sys.argv:
    subprocess.run([sys.executable, str(root/'work/export_bugs0921.py')], cwd=root, timeout=300, check=True)
...
names = ['MulticolorArena.exe','MulticolorArena.pck','README.txt','LAN-Guide.md','VPN-Guide.md','Portable-Guide.md','Fixes-0921.md','SHA256SUMS.json','VerifyFiles.cmd']
...
transfer_tool = root/'builds/CheckTransfer-bugfix0921.cmd'
