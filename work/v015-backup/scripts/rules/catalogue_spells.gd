...
static func resolve(e,t):
 ...
 match id:
  ...
  "spell-fdf-014":p.etb_curse=int(p.get("etb_curse",0))+1
  "spell-fdf-057":
...
static func resolve_complex_choice(e,t):
 ...
 match t.effect:
  ...
  "cat:spell_copy":
   var c=d.card;var copy={"id":e.next_stack,"kind":"card","card":c,"owner":who,"target":C.retarget_result(a),"name":e.cards[c.card_id].name,"copy":true};e.next_stack+=1;e.stack.append(copy);e.priority=e.active;e.passes=0
  "cat:copy_exile":
