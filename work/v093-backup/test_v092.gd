...
func run():
 ...
 expect(view.browser_panel.position.x>1200 and view.browser_cards is VBoxContainer,"right-hand vertical list")
 ...
 for choice in range(3):
  ...
  view.render(); await settle(); view.request_cast(sunny.uid)
 ...
 expect(attack_button!=null and attack_button.position.x<300 and attack_button.position.y>650,"attack confirmation appears at bottom left")
