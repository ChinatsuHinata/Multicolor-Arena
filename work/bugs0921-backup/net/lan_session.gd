...
func can_act(in_match: bool=false) -> bool:return not read_only and not ended() and connected and not paused and not busy and (not in_match or sequence==view_sequence)
