...
static func free_cast(e,c: Dictionary,who: int) -> bool:
 return (forced(e,c,who) and e.forced_cast.get("free",true)) or Cat.State.free_cast(e,c,who) or (c.get("excel_access",{}).get("owner",-1)==who and c.excel_access.turn==e.turn) or e.players[who].field.any(func(u):return has(e.cards[u.card_id],"free_anthem"))
