...
func shift(c: Dictionary, location: String):
 ...
 for k in ["drunk_counters","n21_drunk_triggered","n21_suika_return","n21_spirit","courage","moods","minus_counters","scare","freeze_until","perfect_lock","control_return","died_turn","excel_access"]:c.erase(k)
