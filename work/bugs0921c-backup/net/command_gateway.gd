...
static func apply(e,seat: int,command: Dictionary) -> String:
 ...
 var count={"mulligan":1,"pass_priority":0,"possession":2,"discard":1,"attack":3,"block":1,"combat_damage":1,"surrender":0,"choose_trigger_order":1,"choose_trigger":1,"choose_return":1,"choose_grave_replacement":1,"choose_effect":1,"choose_timer":1,"commit_cast":3,"commit_ability":4,"commit_extension":4}
 if not count.has(name) or a.size()!=count[name]:return "未知操作"
 if e.winner!=-2:return "本局已结束"
 var needs_pending={"possession":"possession","discard":"discard","block":"block","combat_damage":"damage_assignment","choose_trigger_order":"trigger_order","choose_trigger":"trigger","choose_return":"leader_return","choose_grave_replacement":"grave_replacement","choose_effect":"effect_choice","choose_timer":"timer"}
 if needs_pending.has(name) and (e.pending.get("kind","")!=needs_pending[name] or e.pending.get("owner",-1)!=seat):return "不是你的选择时机"
 var types={"mulligan":[TYPE_ARRAY],"possession":[TYPE_INT,TYPE_INT],"discard":[TYPE_ARRAY],"attack":[TYPE_INT,TYPE_DICTIONARY,TYPE_ARRAY],"block":[TYPE_ARRAY],"combat_damage":[TYPE_DICTIONARY],"choose_trigger_order":[TYPE_INT],"choose_trigger":[TYPE_DICTIONARY],"choose_return":[TYPE_BOOL],"choose_grave_replacement":[TYPE_BOOL],"choose_effect":[TYPE_DICTIONARY],"choose_timer":[TYPE_INT],"commit_cast":[TYPE_INT,TYPE_DICTIONARY,TYPE_ARRAY],"commit_ability":[TYPE_INT,TYPE_INT,TYPE_DICTIONARY,TYPE_ARRAY],"commit_extension":[TYPE_INT,TYPE_DICTIONARY,TYPE_ARRAY,TYPE_STRING]}
