...
const ACTIVATIONS=["courage_ping","courage_die","tokiko_copy","mask_joy","mask_anger","mask_sorrow","hatate_return","hina_redirect","clown_sweep","satori_discard","alice_search","alice_recycle","kanako_blast","kaguya_end","suika_counter","sanae_search"]
