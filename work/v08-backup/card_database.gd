...
const IDS=["50","53","54","56","57","68","70","96","99","100","112","164","165","167","170"]
const COLORS=["红","蓝","绿","黄","黑"]
static var last_error=""
const HANDLERS=["marisa_enter","marisa_spell","brave","exterminate","damage","counter_card","mana","grant_leader_abilities","activated_damage","annihilate","flash","turn_buff"]
