...
func build(net,area: Rect2):
 ...
 var frame=StyleBoxFlat.new();frame.bg_color=Color("#14212d");frame.border_color=Color("#d9b775");frame.set_border_width_all(2);frame.set_corner_radius_all(10)
 add_theme_stylebox_override("panel",frame)
 var title=Label.new();title.text="联机聊天";title.position=Vector2(15,12);title.size=Vector2(area.size.x-70,30);title.add_theme_font_size_override("font_size",21);title.add_theme_color_override("font_color",Color("#d9b775"));add_child(title)
