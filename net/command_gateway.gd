...
static func apply(e,seat: int,command: Dictionary) -> String:
 ...
 var count={"mulligan":1,"pass_priority":0,"possession":2,"discard":1,"attack":3,"block":1,"combat_damage":1,"surrender":0,"choose_trigger_order":1,"choose_ward":1,"choose_trigger":1,"choose_return":1,"choose_grave_replacement":1,"choose_effect":1,"choose_timer":1,"commit_cast":3,"commit_ability":4,"commit_extension":4,"toggle_ran_discount":1}
 ...
 if name in ["mulligan","pass_priority","attack","surrender","commit_cast","commit_ability","commit_extension","toggle_ran_discount"]:result=e.callv(name,[seat]+a)
